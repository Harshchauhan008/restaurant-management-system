...
function CashierDashboard() {
    ...
    const [activeReceptionTab, setActiveReceptionTab] =
    ...
    const [reservationDate, setReservationDate] =
        useState(() => getTodayLocalString());

    const [billingView, setBillingView] =
        useState("DAY");
    ...
    const requestJson = async (
        ...
        if (!response.ok) {
            ...
            if (response.status === 401) {
                message =
                    "Cashier login session has expired. Please login again.";
            }
        ...
        return (
            billList.find(
                (bill) => {
                    ...
                    /*
                     * Some BillResponse objects may only
                     * expose orderNumbers, so we also
                     * check those safely above.
                     */
    ...
    const loadServedOrders =
        useCallback(async () => {
            const data =
                await requestJson(
                    `${API_BASE_URL}/cashier/orders/served`
                );
    ...
    const loadBills =
        useCallback(async () => {
            ...
            const data =
                await requestJson(
                    `${API_BASE_URL}/bills/range?${params.toString()}`
                );
    ...
    const changeReservationStatus =
        async (
            ...
            try {
                ...
                setSuccessMessage(
                    `Reservation ${config.label}d successfully.`
                );
            } catch (err) {
                console.error(
                ...
                setError(
                    err.message ||
                        `Unable to ${config.label} reservation.`
                );
            } finally {
    ...
    const reservationsForSelectedView =
        useMemo(() => {
            if (
                reservationView ===
                "DAY"
    ...
    const viewBill = async (
        ...
        try {
            ...
            const data =
                await requestJson(
                    `${API_BASE_URL}/cashier/bills/${billId}`
                );
    ...
    const generateBill =
        async (order) => {
            ...
            try {
                ...
                /*
                 * First check locally loaded bills.
                 */
                ...
                /*
                 * If not found locally, ask backend
                 * for all bills as a fallback.
                 */
                ...
                if (!existingBill) {
                    try {
                        ...
                        console.error(
                            "Unable to check existing bills:",
                            loadError
                        );
                    }
                }
                ...
                const data =
                    await requestJson(
                        `${API_BASE_URL}/cashier/bills/order/${orderId}`,
                        {
                            method: "POST",
                        }
                    );
                ...
                /*
                 * Refresh served orders and bills
                ...
                setSuccessMessage(
                    data?.billNumber
                        ? `${data.billNumber} generated successfully.`
                        : "Bill generated successfully."
                );
            } catch (err) {
                /*
                 * Backend may say the bill already exists.
                 * In that case, reload all bills and open it.
                 */
    ...
    const printBill =
        async (bill) => {
            ...
            try {
                ...
                const response =
                    await fetch(
                        `${API_BASE_URL}/cashier/bills/${billId}/print`,
                        {
                            method: "GET",
                            headers:
                                getHeaders(),
                ...
                if (!printWindow) {
                    throw new Error(
                        "Popup blocked. Please allow popups to print the bill."
                    );
                }
                ...
                const marked =
                    await requestJson(
                        `${API_BASE_URL}/cashier/bills/${billId}/printed`,
                        {
                            method: "PATCH",
                        }
                    );
    ...
    const markPaid =
        async (bill) => {
            ...
            try {
                ...
                const data =
                    await requestJson(
                        `${API_BASE_URL}/cashier/bills/${billId}/paid`,
                        {
                            method: "PATCH",
                        }
                    );
                ...
                setSuccessMessage(
                    data?.billNumber
                        ? `${data.billNumber} marked as paid.`
                        : "Bill marked as paid."
                );
            } catch (err) {
                console.error(
    ...
    /* =========================================================
       ...
       NEW:
       Served orders waiting for a bill
       are shown here automatically.
    ========================================================= */

    const billingQueueOrders =
        useMemo(() => {
        ...
        return (
            <div className="cashier-page">
                <div className="cashier-state">
                    ...
                    <strong>
                        Loading Reception & Cashier
                    </strong>

                    <p>
                        Preparing front desk operations...
                    </p>
                </div>
            </div>
        );
        ...
        <div className="cashier-page">
            ...
            {successMessage && (
                <div className="cashier-alert cashier-success">
                    ...
                    <span className="cashier-alert-icon">
                        ✓
                    </span>
                    ...
                    {activeReceptionTab ===
                        ...
                        <section className="cashier-section">
                            ...
                            <div className="cashier-reservation-date-navigation">
                                ...
                                <div className="cashier-current-period">
                                    {
                                        reservationPeriodTitle
                                    }
                                </div>
                                ...
                                <button
                                    type="button"
                                    className="cashier-today-button"
                                    onClick={
                                        goToToday
                                    }
                                >
                                    ...
                                    {weekDays.map(
                                        (
                                            ...
                                            >
                                                ...
                                                <div className="cashier-week-day-label">
                                                    {
                                                        day.label
                                                    }
                                                </div>

                                                <div className="cashier-week-day-number">
                                                    {
                                                        day.number
                                                    }
                                                </div>
                                        ...
                                        {[
                                            ...
                                            (
                                                ...
                                                <div
                                                    ...
                                                    className="cashier-month-weekday"
                                                >
                                                    {
                                                        day
                                                    }
                                            ...
                                            (
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <span className="cashier-month-number">
                                                            {
                                                                day.number
                                                            }
                                                        </span>
                                        ...
                                        (
                                            ...
                                            return (
                                                <article
                                                    ...
                                                    className={`cashier-reservation-card ${getStatusClass(
                                                        status
                                                    )}`}
                                                >
                                                    ...
                                                    <div className="cashier-reservation-card-header">
                                                        ...
                                                        <span
                                                            className={`cashier-status ${getStatusClass(
                                                                status
                                                            )}`}
                                                        >
                                                            {
                                        ...
                                        (
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={`cashier-table-card ${getTableStatusClass(
                                                        table?.status
                                                    )}`}
                                                >
            ...
            {activeMainTab ===
                ...
                <section className="cashier-section">
                    ...
                    {/* =================================================
                        SERVED ORDERS WAITING FOR BILL
                    ================================================= */}
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="cashier-data-card-top">
                                                    ...
                                                    <span className="cashier-status served">
                                                        Served
                                                    </span>
                                    ...
                                    (
                                        ...
                                        >
                                            ...
                                            <div className="cashier-data-card-top">
                                                ...
                                                <span
                                                    className={`cashier-status ${getBillStatusClass(
                                                        bill?.status
                                                    )}`}
                                                >
                                                    {
